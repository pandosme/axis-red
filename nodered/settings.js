...
module.exports = {
    ...
    adminAuth: {
        ...
        users: [{
            username: "admin",
            password: "$2a$08$sGZ5b3Ygo9erkV6i6qpBGeItkFI/H7siMKhZqi1VP0QBVEj22GjbO",
            permissions: "*"
        }]
    },
    ...
    httpNodeAuth: {
		user:"user",
		pass:"$2a$08$sGZ5b3Ygo9erkV6i6qpBGeItkFI/H7siMKhZqi1VP0QBVEj22GjbO"
	},
    ...
    contextStorage: {
        default: {
			...
			config: {
				"dir":"/var/spool/storage/SD_DISK/NodeRED/node-red-data",
				"flushInterval": 600
			},
        },
    },
